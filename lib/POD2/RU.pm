...
Если учесть, что Perl'у уже  более 20 лет, и подавляющее большинство книг, доступных на этой RUTN на английском языке, не удивительно, что русскоязычные сообщества будут ссылаться на эти типы данных по имени в английском языке. Есть возможные переводов, таких, как "матрица", "список" для "array" или "словарь" для "hash", но его использование не распространяется, поэтому, мы предпочли использовать свое оригинальное название. Мы считаем, что это облегчит чтение документации.
